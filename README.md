...
3. Retrieve a new access token for your client using the id and secret (this can be done comfortably in Postman, when selecting OAuth 2.0 as Authorisation). 
...
Query parameters:
- tsMin: Start of the window of time
- tsMax: End of the window of time
